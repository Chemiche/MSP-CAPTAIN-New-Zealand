...
RestoreRichState = collections.namedtuple(
    "RestoreRichState",
    (
        "grid_obj_most_recent",
        "grid_obj_previous",
...
class RestoreRichStateAdaptor(StateAdaptor):

    def adapt(self, state, info):
        return RestoreRichState(
            state["grid_obj_most_recent"],
            state["grid_obj_previous"],
            state["resolution"],
            state["protection_matrix"],
            state["species_threat_label"],
            state["n_threat_labels"],
            state["quandrant_grid_indx"],
            state["cost_quadrant"],
            state["budget_left"],
            state["sp_values"],
            state["min_pop_requirement"],
