...
class SimGrid(object):
    ...
    def step(self, action=None, fast_dist=False, skip_dispersal=False):
        # if self._counter == 0:
        ...
        if self._dispersal_before_death == 0:
            ...
            if skip_dispersal is False:
                ...
                NumCandidates = sparse.tensordot(self._h, self._dumping_dist)
                ...
                if self._K_species is not None:
                    ...
                    NumCandidates = growth_rate_3D * NumCandidates
                    NumCandidates[self._K_species == 0] = 0
        ...
        if self._K_species is not None:
            self._h = np.minimum(self._h + NumCandidates, self._K_species)
        else:
        ...
        if self._habitat_suitability is not None:
