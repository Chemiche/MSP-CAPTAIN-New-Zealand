...
result_dir = "train_emp_NZtraits_"
...
trait_tbl = pd.read_csv(os.path.join(data_wd, "species_tbl.csv"))
conservation_status_rev = np.array(trait_tbl['conservation_status'])



# TODO: replace with empirical
...
sdm_pd.to_csv(os.path.join(data_wd, "species_list.csv"))
...
def generate_init_env(r_seeds_dict):
    ...
    # TODO: replace with real sensitivity
